...
pub enum BlockType {
    /// regular empty block, no extra conditions
    Empty,

    /// empty block, generated by 'fade', shouldnt be filled up with any obstacles
    EmptyFade,

    /// empty block in spawn/finish area, should only be modified in room creation
    EmptyRoom,

    /// empty block reserved above platform
    EmptyPlatform,
...
impl BlockType {
    ...
    pub fn to_tw_game_id(&self) -> u8 {
        match self {
            BlockType::Empty | BlockType::EmptyFade | Self::EmptyRoom | Self::EmptyPlatform => 0,
    ...
    pub fn to_tw_block_type(&self) -> BlockTypeTW {
        match self {
            ...
            | BlockType::EmptyFade
            | BlockType::EmptyRoom
            | BlockType::EmptyPlatform => BlockTypeTW::Empty,
