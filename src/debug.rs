...
impl DebugLayers {
    ...
    pub fn new(
        ...
        let bool_layers: BTreeMap<&'static str, BoolLayer> = BTreeMap::from([
            ...
            (
                "pillar_candidates",
                BoolLayer::new(shape, Color::new(0.3, 0.7, 0.9, default_alpha), true),
            ),
            (
                "pillar_placed",
                BoolLayer::new(shape, Color::new(0.2, 0.9, 0.5, default_alpha), true),
            ),
            (
                "valid_path",
                BoolLayer::new(shape, Color::new(0.1, 0.9, 0.9, default_alpha), false),
            ),
        ]);
